...
import { RESET_PASSWORD, VERIFICATION } from '../../../Navigator/AuthenticationNavigator/AuthenticationNavigator';
...
const VerificationScreen = ({ onComplete = () => {}, navigation } : any) => {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      />
        <AFHaveAccBottomView  titleOne={STRINGS.verification.receiveCode} titleTwo={STRINGS.verification.resend} onPress={_forgotPassNextPress} titleOnPress={_resendOnPress}/>
