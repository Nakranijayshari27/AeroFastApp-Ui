...
import { CHALLENGE_VIDEO, CHALLENGE_WORKOUT_SKIP } from "../../../Navigator/HomeNavigator/HomeNavigator";
      ...
      <View style={styles.container}>
        ...
        <View style={styles.workOutNameView}>
          ...
          <View style={styles.progressBarView}>
            ...
            <View style={[styles.button, { width: `${progress}%`, borderTopRightRadius: progress === 100 ? 100 : 0 , borderBottomRightRadius: progress === 100 ? 100 : 0 }]}></View>
          </View>
        </View>
